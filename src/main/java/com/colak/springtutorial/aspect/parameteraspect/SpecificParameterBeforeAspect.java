package com.colak.springtutorial.aspect.parameteraspect;
...
public class SpecificParameterBeforeAspect {
    ...
    public void beforeAnnotatedMethod(JoinPoint joinPoint, SpecificParameter specificParameter) {
        ...
        if (parameterValue != null) {
            log.info("The parameter '{}' was detected in the request with the value:{}", methodParameterName, parameterValue);
        } else {
            log.info("The parameter '{}' was not detected in the request.", methodParameterName);
        }
    }
}